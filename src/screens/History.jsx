          ...
          return (
            <Card key={m.id} tone={matchWon ? "accent" : "default"}>
              ...
              <div className="flex gap-1.5 mt-2 pt-2 border-t border-neutral-800">
                ...
                <button
                  onClick={() => { openReflection(m.id, "history"); setScreen("reflection"); }}
                  className={`flex-1 px-2 py-1 rounded-md text-[11px] font-semibold active:scale-95 border ${
                    reflected
                      ? "bg-neutral-900 hover:bg-neutral-800 border-neutral-700 text-neutral-300"
                      : "bg-emerald-900/40 hover:bg-emerald-900/60 border-emerald-800 text-emerald-200"
                  }`}
                >
